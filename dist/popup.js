...
const Popup = () => {
    ...
    const [unblockCode, setUnblockCode] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
    const maxUnblocks = 3;
    const [notificationMessage, setNotificationMessage] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
    const [notificationType, setNotificationType] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
    const [cooldownExpiration, setCooldownExpiration] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
    const [cooldownCountdown, setCooldownCountdown] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        chrome.storage.local.get([
            ...
            if (storedCooldownExpiration > currentTime) {
                ...
                setCooldownCountdown(Math.floor((storedCooldownExpiration - currentTime) / 1000));
            }
        });
    }, []);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        if (cooldownCountdown !== null && cooldownCountdown > 0) {
            cooldownTimer = setTimeout(() => setCooldownCountdown((prev) => (prev ? prev - 1 : 0)), 1000);
        }
    ...
    const startTimer = (minutes, isPaid = false) => {
        if (!isPaid && unblockCount >= maxUnblocks)
            return; // Prevent free unblock if max is reached
    ...
    const validatePaidUnblockCode = () => __awaiter(void 0, void 0, void 0, function* () {
        const currentTime = Date.now();
        if (cooldownExpiration && currentTime < cooldownExpiration) {
            showNotification("Please wait until the cooldown period is over.", "error", 5000);
            return;
        }
        try {
            // Fetch the current list of codes
            const response = yield fetch("https://api.sheetbest.com/sheets/ef14d1b6-72df-47a9-8be8-9046b19cfa87");
            const data = yield response.json();
            // Check if the entered code is valid and not already used
            const codeEntry = data.find((entry) => entry.Code === unblockCode && entry.isUsed === "FALSE");
            if (codeEntry) {
                ...
                yield fetch(`https://api.sheetbest.com/sheets/ef14d1b6-72df-47a9-8be8-9046b19cfa87/Code/${unblockCode}`, {
                    method: "PATCH",
                    mode: "cors",
                    headers: {
                ...
                showNotification("Paid unblock code applied successfully!", "success", 5000);
            }
            else {
            ...
            showNotification("Failed to validate code. Please try again.", "error", 5000);
        }
    });
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { style: { fontSize: "10px", color: "#333", fontWeight: "bold" } }, "The Bet Blocker")),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", { style: { fontSize: "12px", marginBottom: "20px", color: "#333" } },
            ...
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: "https://docs.google.com/document/d/1OPNpl-iGCarB77_h4sUenV_4Pyf_Yvn3_R_xmqnGRuc/edit?usp=sharing", target: "_blank", rel: "noopener noreferrer", style: { color: "#d72323", textDecoration: "none" } }, "View Blocked Gambling Sites")),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { style: { fontSize: "14px", color: "#555", marginBottom: "10px" } },
            ...
            "/",
            maxUnblocks),
        !timerRunning ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { style: {
                ...
                }, onClick: () => startTimer(5), disabled: unblockCount >= maxUnblocks }, "Free 5 Minutes Unblock"),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: { marginTop: "20px" } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { style: { fontSize: "14px", marginBottom: "10px" } }, "Paid Unblock (30 Minutes)"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "text", value: unblockCode, onChange: (e) => setUnblockCode(e.target.value), placeholder: "Enter paid code", style: {
                        padding: "10px",
                        width: "80%",
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { style: {
                        ...
                        cursor: "pointer",
                        fontSize: "14px",
                    }, onClick: validatePaidUnblockCode, disabled: cooldownCountdown !== null && cooldownCountdown > 0 }, "Apply Code"),
                cooldownCountdown !== null && cooldownCountdown > 0 && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { style: { color: "#d72323", marginTop: "10px" } },
                    "You are currently in a cooldown period. You can apply for a paid unblock after: ",
                    formatTime(cooldownCountdown)))))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { width: "120", height: "120", viewBox: "0 0 100 100" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("circle", { cx: "50", cy: "50", r: "45", stroke: "#E0E0E0", strokeWidth: "6", fill: "none" }),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("circle", { cx: "50", cy: "50", r: "45", stroke: "#d72323", strokeWidth: "6", fill: "none", strokeDasharray: `${2 * Math.PI * 45}`, strokeDashoffset: calculateStrokeDashoffset(), style: { transition: "stroke-dashoffset 1s linear" } }),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("text", { x: "50", y: "55", textAnchor: "middle", fontSize: "18", fill: "#d72323", fontWeight: "bold" },
                    Math.floor(countdown / 60),
                    ":",
                    String(countdown % 60).padStart(2, "0"))))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "notification", style: {
                marginBottom: "10px",
                padding: "10px",
                color: notificationType === "success" ? "#004400" : "#ff0000",
                backgroundColor: notificationType === "success" ? "#ccffcc" : "#ffe5e5",
                border: `1px solid ${notificationType === "success" ? "#004400" : "#a00"}`,
                borderRadius: "5px",
                fontSize: "14px",
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: "https://buy.stripe.com/fZeeYn4zyc9E5jy8ww", target: "_blank", rel: "noopener noreferrer", style: { color: "#d72323", textDecoration: "none" } }, "Purchase 30 Min Unblock ($5)"))));
};
